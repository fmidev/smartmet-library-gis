...
void expand_geometry()
{
  ...
  ok =
      "POLYGON ((24.981818759994205 60.19245120891479,24.981818759994205 "
  ...
  ok =
      "POLYGON ((24.977089374263791 60.292969736329617,24.977254003888774 "
...
void exportToSvg_precision()
{
  ...
  exportToSvg(*line, Box::identity(), precision);
