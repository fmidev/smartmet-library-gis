...
bool Shape::connectPoints_cw(OGRLinearRing& ring,double x1,double y1,double x2,double y2,double theMaximumSegmentLength) const
{
  throw Fmi::Exception(BCP,"Not implemented!");
}
...
bool Shape::connectPoints_ccw(OGRLinearRing& ring,double x1,double y1,double x2,double y2,double theMaximumSegmentLength) const
{
  throw Fmi::Exception(BCP,"Not implemented!");
}
...
LineIterator Shape::search_cw(OGRLinearRing *ring,std::list<OGRLineString *> &lines,double x1,double y1,double &x2,double &y2) const
{
  throw Fmi::Exception(BCP,"Not implemented!");
}
...
LineIterator Shape::search_ccw(OGRLinearRing *ring,std::list<OGRLineString *> &lines,double x1,double y1,double &x2,double &y2) const
{
  throw Fmi::Exception(BCP,"Not implemented!");
}
